...
<div class="agenda-wrapper col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display: flex; justify-content: center; height: 100vh;">
	...
	<div class="col-lg-3 col-md-3 hidden-sm hidden-xs ducky-container" style="position: fixed; right: 0; bottom: 0; height: 100%; z-index: 10;" >
		<img class="duck-one img-responsive" style="position: absolute; bottom: 0; right: 0; z-index: 1;" src="<?php echo e(URL::asset('/images/home/eendje_1.png')); ?>" alt="explainer duckling">
		<img class="duck-two img-responsive " style="position: absolute; bottom: 0; right: 0; z-index: 0;" src="<?php echo e(URL::asset('/images/home/eendje_2.png')); ?>" alt="explainer duckling">
	</div>
