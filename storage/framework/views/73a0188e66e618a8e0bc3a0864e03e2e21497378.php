...
<?php $__env->startSection('content'); ?>
	...
	<div class="container col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="row">
			<img class="animated fadeInUp img-responsive col-lg-8 col-lg-offset-2" style="margin-bottom: 75px; margin-top: 75px;" src="<?php echo e(URL::asset('/images/Home/biografie.jpeg')); ?>" alt="amber-titelblad">
		</div>
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2 col-md-12 col-sm-12 col-xs-12" style="display: flex; align-items: center; justify-content: center; font-family: Georgia; color: white; font-size: 2em;">
		...
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2 col-md-12 col-sm-12 col-xs-12" style="margin-top: 50px; font-weight: bold; text-align: justify; display: flex; align-items: center; justify-content: center; font-family: Georgia; color: white; font-size: 2em;">
		...
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2 col-md-12 col-sm-12 col-xs-12" style="margin-top: 50px; display: flex; align-items: center; justify-content: center; font-family: Georgia; color: white; font-size: 1.75em;">
