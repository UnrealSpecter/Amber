...
<?php $__env->startSection('content'); ?>
	...
	<div class="container col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="row">
			<img class="animated fadeInUp" style="max-height: 100%; width: 100%;" src="<?php echo e(URL::asset('/images/Home/header_amber_rozema.jpg')); ?>" alt="amber-titelblad">
		</div>
		...
		<div class="row breath">
			<img class="animated fadeInUp img-responsive col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1" src="<?php echo e(URL::asset('/images/Home/biografie.jpeg')); ?>" alt="amber-titelblad">
		</div>
		<div class="row breath">
			<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 amber-info">
		...
		<div class="row social-media" style="margin-top: 50px;">
			...
			<div class="col-lg-4 col-xs-12 social-media-icons">
